...
export interface ApiAboutPageAboutPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ceo_section: Schema.Attribute.Component<'about.ceo-profile', false>;
    core_values: Schema.Attribute.Component<'about.value', true>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    factory_tour_cta: Schema.Attribute.Component<'shared.button', false>;
    ...
    >;
    mission_statement: Schema.Attribute.Text &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 1000;
      }>;
    ...
    timeline_events: Schema.Attribute.Component<'about.timeline-event', true>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    vision_statement: Schema.Attribute.Text &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 1000;
      }>;
...
export interface ApiCategoryCategory extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    pillar_page_content: Schema.Attribute.RichText;
    pillar_page_faq: Schema.Attribute.Component<'shared.faq-item', true>;
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.UID<'name'> & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiContactPageContactPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    contact_faq: Schema.Attribute.Component<'shared.faq-item', true>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    email_sales: Schema.Attribute.Email &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
    ...
    email_support: Schema.Attribute.Email &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
      }>;
    factory_address: Schema.Attribute.RichText & Schema.Attribute.Required;
    form_inquiry_types: Schema.Attribute.Component<
      'contact.inquiry-type',
      true
    >;
    google_maps_embed_url: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
...
export interface ApiGlobalSeoGlobalSeo extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    default_meta_image: Schema.Attribute.Media<'images'>;
...
export interface ApiHomepageHomepage extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Main homepage content with dynamic zones';
  ...
  attributes: {
    content_sections: Schema.Attribute.DynamicZone<
      [
...
export interface ApiKnowledgeAssetKnowledgeAsset
  extends Struct.CollectionTypeSchema {
  collectionName: 'knowledge_assets';
  info: {
    description: 'Blog posts, articles, and knowledge resources';
    displayName: 'Knowledge Asset';
    pluralName: 'knowledge-assets';
    singularName: 'knowledge-asset';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Coffee product catalog';
    displayName: 'Product';
    pluralName: 'products';
  ...
  attributes: {
    altitude_range: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    cupping_score: Schema.Attribute.Decimal &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
    ...
    featured_image: Schema.Attribute.Media<'images'> &
      Schema.Attribute.Required;
    full_description: Schema.Attribute.RichText & Schema.Attribute.Required;
    gallery: Schema.Attribute.Media<'images', true> &
      Schema.Attribute.SetMinMax<
        ...
        number
      >;
    harvest_season: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
    ...
    localizations: Schema.Attribute.Relation<
      ...
      'api::product.product'
    >;
    moisture_content: Schema.Attribute.Decimal &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
    ...
    origin_region: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
    ...
    origin_story: Schema.Attribute.RichText;
    packaging_options: Schema.Attribute.Component<'product.packaging', true>;
    price_range: Schema.Attribute.String &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 100;
      }>;
    processing_method: Schema.Attribute.Enumeration<
      ['washed', 'honey', 'natural', 'other']
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
    ...
    related_products: Schema.Attribute.Relation<
      ...
      'api::product.product'
    >;
    screen_size: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
...
export interface ApiServiceService extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'B2B services offered';
    displayName: 'Service';
    pluralName: 'services';
  ...
  attributes: {
    capabilities: Schema.Attribute.Component<'service.capability', true>;
    ...
    process_steps: Schema.Attribute.Component<'service.process-step', true>;
    publishedAt: Schema.Attribute.DateTime;
    related_products: Schema.Attribute.Relation<
      'manyToMany',
      'api::product.product'
...
export interface ApiSiteSettingsSiteSettings extends Struct.SingleTypeSchema {
  ...
  info: {
    ...
    pluralName: 'site-settings-single';
...
export interface ApiTestimonialTestimonial extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    reviewer_avatar: Schema.Attribute.Media<'images'> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
      }>;
    reviewer_company: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::knowledge-asset.knowledge-asset': ApiKnowledgeAssetKnowledgeAsset;
